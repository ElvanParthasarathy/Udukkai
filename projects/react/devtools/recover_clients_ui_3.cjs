...
const startStr = '<div className="dashboard-container">';
const endStr = '              <div key={clientName} className="glass-panel mb-4" style={{ overflow: \\'hidden\\' }}>';

const startIdx = v.indexOf(startStr);
const endIdx = v.indexOf(endStr) + endStr.length;

if (startIdx !== -1 && endIdx !== -1 && endIdx > startIdx) {
  const newBlock = `    <div className="dashboard-container">
  ...
  v = v.substring(0, startIdx) + newBlock + v.substring(endIdx);
