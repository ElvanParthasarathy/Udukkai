...
/**
 * ElvanSheetConfirmButton — 'Done / Confirm' bottom action matching Flutter's PatruPattiyalTheervuMaeladukku 1:1.
 * Top divider: outline 10% opacity.
 * Centered Row: label (15sp, FontWeight.Medium 500, 80% opacity onSurface).
 * Padding: horizontal 32dp, vertical 16dp.
 */
@Composable
fun ElvanSheetConfirmButton(
    onTap: () -> Unit,
    modifier: Modifier = Modifier,
    label: String = K.done.tr(),
